...
export default function Products() {
  ...
  // Function that handles dropdown menu for sorting
  ...
  // Function that handles dropdown menu for filtering
  ...
  // Function that handles filtering
  ...
  // Function that handles clearing filters/sorting
  function handleClearFilters() {
    resultsMessage.current.style.display = "none";
    setUrl("/database");
  }

  // This is a functional component that returns a JSX element with the products
  return (
    <>
      <meta charSet="UTF-8" />
          ...
          <div id="dropDownBtns">
            <div className="dropdown">
              ...
              <div id="sortDropdown" class="dropdown-content">
                ...
                <button onClick={() => handleSort("Name A - Z")}>
                  Product Name A - Z
                </button>
                <button onClick={() => handleSort("Name Z - A")}>
                  Product Name Z - A
                </button>
                <button onClick={() => handleSort("Rating High to Low")}>
                  Rating High To Low
                </button>
                <button onClick={() => handleSort("Rating Low to High")}>
                  Rating Low To High
                </button>
              </div>
            </div>
            <div className="dropdown">
              ...
              <div id="filterDropdown" class="dropdown-content">
                <button onClick={() => handleFilter("Singleplayer")}>
                  Single Player
                </button>
                <button onClick={() => handleFilter("Multiplayer")}>
                  Multiplayer
                </button>
                <button onClick={() => handleFilter("RPG")}>
                  RPG (Role-Playing Game)
                </button>
                <button onClick={() => handleFilter("Beat 'em up")}>
                ...
                <button onClick={() => handleFilter("Simulator")}>
                  Simulator
                </button>
              </div>
            </div>
