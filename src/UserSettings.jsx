...
export default function UserSettings() {
  // Refs for the input fields and error messages
  ...
  // Function to handle the change of the email
  ...
  // This is a functional component that returns a JSX element with the user settings page
  return (
    <div>
      <Header />
      <h1 id="helloMessage">
        Welcome, {localStorage.getItem("currentUser").replaceAll('"', "")}
      </h1>
      <main id="userSettingsMain">
        <div id="profileContainer">
          ...
          <div className="profileOption">
            ...
            <div>
              <p ref={userName}>
                {localStorage.getItem("currentUser").replaceAll('"', "")}
              </p>
              <small
                ref={editNameBtn}
            ...
            <ChangeName
              ...
              getValue={(e) => setUsername(e.target.value)}
            />
          </div>
          <div className="profileOption">
            <h4>Email</h4>
            ...
            <div>
              <p ref={email}>
                {localStorage.getItem("userEmail").replaceAll('"', "")}
              </p>
              <small
                ref={editEmailBtn}
                className="editBtns"
            ...
            <ChangeEmail
              ...
              getValue={(e) => setEmailValue(e.target.value)}
            />
          </div>
          <div className="profileOption" id="passwordSettings">
            ...
            <ChangePassword
              ref={editPasswordInput}
              handleClosePassword={handleClosePassword}
              handleSubmit={handlePasswordSubmit}
              getCurrent={(e) => setcurrentPassword(e.target.value)}
              getNewPass={(e) => setNewPass(e.target.value)}
              getConfirmPass={(e) => setConfirmPass(e.target.value)}
            />
          </div>
        </div>
      </main>
